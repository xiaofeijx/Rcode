...
modifieddf[difftime(modifieddf[,38],modifieddf[,37],units="hours") >= 2 & mclassone, showcol_1]

```
**订正报告卡时限检查（乙丙类）**
```{r}
#显示订正报告的传报卡，报告时间超过24小时
modifieddf[difftime(modifieddf[,30],modifieddf[,19],units="days") >= 1, showcol_1]
```
